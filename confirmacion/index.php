						...
						<div class="col col-3">
							<div class="card mt-5 bg-secondary" style="width: 13rem;" >
								...
								<div class="card-body">
									...
									<a href='http://localhost/software/Sistema_venta_basico-master/index.php' class='btn btn-sm btn-outline-info mt-2'> Abrir <i class=' bi bi-file-earmark-plus'></i></a>
								</div>
							</div>
						</div>
					<div class="col col-3">
						<div class="card mt-5 bg-secondary" style="width: 13rem;" >
							...
							<div class="card-body">
								...
								<a href='http://localhost/software/INVENTARIO/index.php?vista=home' class='btn btn-sm btn-outline-info mt-2'> Abrir <i class=' bi bi-file-earmark-plus'></i></a>
							</div>
						</div>
					</div>
					<div class="col col-3">
				...
				<div class="row justify-content-center">
					<div class="col col-3">
						<div class="card mt-5 bg-secondary" style="width: 13rem;" >
							<i class="bi bi-people-fill" style="font-size: 6em; margin-left: 40px; margin-top: 20px;"></i>
							<div class="card-body">
								<p class="card-text"><b>Trabajadores: </b>0</p>
								<a href='"+num+".php' class='btn btn-sm btn-outline-info mt-2'> Abrir <i class=' bi bi-file-earmark-plus'></i></a>
							</div>
						</div>
					</div>
					...
					<div class="col col-3">
						<div class="card mt-5 bg-secondary" style="width: 13rem;" >
							...
							<div class="card-body">
								<p class="card-text"><b>Cierre Caja: </b>0</p>
								<a href='"+num+".php' class='btn btn-sm btn-outline-info mt-2'> Abrir <i class=' bi bi-file-earmark-plus'></i></a>
							</div>
						</div>
					</div>
